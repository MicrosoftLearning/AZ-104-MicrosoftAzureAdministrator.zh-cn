...
1. 单击“下一页: IP 地址”。 “起始地址”为 10.40.0.0 。 “地址空间大小”为 /20 。 

1. 单击“+ 添加子网”****。 删除现有 **默认** 子网。 输入以下值，然后单击“添加”****。 
...
在此任务中，你将配置分配到 Azure 虚拟机网络接口的公共 IP 地址和专用 IP 地址的静态分配。
   ...
   >注意：需要两个公共 IP 地址才能完成本实验室。 

1. 在 Azure 门户中，搜索并选择“公共 IP 地址”，然后选择“+ 创建” 。

1. 确保资源组为“az104-04-rg1” ，

1. 在“配置详细信息”中，确保名称为“az104-04-pip0”  。
...
1. 在“配置详细信息”中，确保名称为“az104-04-pip1”  。
...
1. 选择“关联公共 IP 地址”，并在“公共 IP 地址”下拉列表中选择“az104-04-pip0”  。

    >**注意：** 如果收到错误，*表明域名已被使用*，这是一个已知问题。 需要找到公共 IP 地址并将其单独关联到 NIC。
    >
    > + 转到“公共 IP 地址”****
    > + 单击“az104-04-pip0”****
    > + 在“概述”窗格中****，单击“关联 IP”****
    > + 将“资源类型”设置为“网络接口”********
    > + 将“网络接口”设置为“az104-04-nic0”********
    > + 对 **az104-04-pip1** 和 **az104-04-nic1** 重复上述操作
...
1. 选择“关联公共 IP 地址”，并在“公共 IP 地址”下拉列表中选择“az104-04-pip1”  。
