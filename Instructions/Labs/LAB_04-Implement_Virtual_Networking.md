...
>**注意：** 还可以使用 Azure 门户菜单（左上角图标）找到此资源。 选择“创建资源”，然后在“网络”边栏选项卡中选择“网络安全组”。************ 
...
1. 请注意 AllowInternetOutBound**** 规则。 另请注意，无法删除规则，并且优先级为 65001。
