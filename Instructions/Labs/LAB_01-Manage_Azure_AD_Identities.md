...
>**备注**：如果你之前在此 Azure AD 租户上使用过 Azure AD Premium 的试用版许可证，则需要一个新的 Azure AD 租户，并在这个新的 Azure AD 租户中在执行任务 3 后执行任务 2。
...
1. 单击“**+ 添加表达式**”，再单击“**保存**”来保存规则。返回“**新建组**”边栏选项卡，单击“**创建**”。 
...
1. 导航到 Contoso 实验室 Azure AD 租户的“**Contoso Lab - 概述**”边栏选项卡，单击“**管理租户**”，然后在下一个屏幕上，依次单击“**删除租户**”、“**获取删除 Azure 资源的权限**”链接，在 Azure Active Directory 的“**属性**”边栏选项卡上，将“**Azure 资源的访问管理**”设置为“**是**”，并单击“**保存**”。
