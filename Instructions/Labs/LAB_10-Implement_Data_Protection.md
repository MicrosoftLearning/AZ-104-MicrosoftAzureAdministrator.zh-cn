...
1. 在“恢复服务保管库”边栏选项上，在“设置”部分中单击“属性”。********
...
1. 移动到“高级设置”选项卡。**** 已为你选择了资源。 请务必检查它们。 

1. 验证你的订阅、VM 资源组、虚拟网络和可用性（采用默认值）设置。

1. 在“存储设置”中，选择“显示详细信息”。********
   ...
   >**注意：** 必须填充这两个设置，否则验证将失败。 如果值不存在，请尝试刷新页面。 如果这不起作用，请创建一个空的存储帐户，然后返回到此页面。

1. 在“复制设置”中，选择“显示详细信息”。******** 请注意，已自动选择了区域 2 中你的恢复资源保管库。
