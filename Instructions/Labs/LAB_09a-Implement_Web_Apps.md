...
1. 在“创建 Web 应用”边栏选项卡的“基本信息”选项卡中，指定以下设置（其他设置保留默认值） ：
 ...
 1. 单击“查看 + 创建”，然后单击“创建”********。
    ...
    >**备注**：如果部署失败，请更改为另一个区域，然后重试。 例如，切换到**美国东部 2**。 
...
1. 返回 Web 应用的“部署槽位”边栏选项卡，单击表示新创建的过渡槽的条目****。
...
1. 在 Web 应用的“概述”边栏选项卡上，选择“默认域”链接以显示网站主页********。

1. 验证生产网页是否显示“Hello World!”**** 页面。
...
1. 在“概述” | “添加 HTTP 请求”中，选择“创建”************。

1. 在“**测试计划**”选项卡上，单击“**添加请求**”。 在“**URL 字段**”中，粘贴你的 **默认域** URL。 确保格式正确，并以 https:// 开头****。

1. 依次选择“审阅 + 创建”和“创建”。

    >**注意：** 创建测试可能需要几分钟。 

1. 查看测试结果，包括“虚拟用户”、“响应时间”和“请求数/秒”************。
