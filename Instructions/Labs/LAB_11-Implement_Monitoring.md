...
1. 将**\\Allfiles\\Labs\\11\\az104-11-vm-template.json** 实验室文件下载到你的计算机。
...
1. 找到并选择**\\Allfiles\\Labs\\11\\az104-11-vm-template.json** 文件，然后选择“打开”****。
...
1. 你应该会收到一封电子邮件通知，“**重要通知：Azure Monitor VM 已删除警报已激活...**”如果没有收到，请打开电子邮件程序并查找来自azure-noreply@microsoft.com 的电子邮件。
