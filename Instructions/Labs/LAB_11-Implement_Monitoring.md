...
1. 选择资源组对应的复选框，然后选择“**应用**”。 此警报将应用于资源组中的任何虚拟机。 或者，也可以指定一台特定计算机。 
...
1. 选中“**应用强制删除**”框。 输入“`delete`”进行确认，然后选择“**删除**”。 
...
1. 在 Azure 门户中，搜索并选择 `Monitor` 边栏选项卡，然后点击“**日志**”。

1. 如有必要，请关闭初始屏幕。 

1. 选择你的**资源组**作为范围。 选择“应用”。 

1. 在“**查询**”选项卡中，选择“**虚拟机**”（左窗格）。 
