...
1. 在“**网络**”选项卡的“**公共网络访问**”部分，选择“**禁用**”。 这将限制入站访问，同时允许出站访问。 
...
1. 在“安全 + 网络”**** 边栏选项卡中，选择“网络”****。 请注意，“**公共网络访问**”已禁用。
    ...
    + 选择“管理”并将“公用网络访问”设置更改为“已启用”。************ 
    + 将“公用网络访问范围”更改为“从所选网络启用”。********
    + 在“IPv4 地址”部分中，选择“添加客户端 IPv4 地址”。********
    + 保存所做更改。
...
1. 在“**数据管理**”边栏选项卡中，选择“**生命周期管理**”，然后选择“**添加规则**”。
    ...
    + 在“基本 blob”选项卡上，如果基本 blob 的上次修改时间早于 `30` 天前，则“移动到冷存储”************。 注意你的其他选择。 
...
1. 选择上传文件并查看省略号 (...) 选项，包括“下载”、“删除”、“更改层级”和“获取租约”****************。

1. 复制文件 URL（“设置”-->“属性”边栏选项卡）并将其粘贴到新的 InPrivate 浏览窗口。********
...
1. 选择“添加虚拟网络”，然后选择“添加现有网络”。********

1. 选择 vnet1 和默认子网，然后选择“添加”。************

1. 在“IPv4 地址”部分中，删除你的计算机 IP 地址********。 应该只允许来自虚拟网络的流量。 
...
1. 选择“存储浏览器”，然后选择“刷新”以刷新页面********。 导航到文件共享或 blob 内容。  
    ...
    >**注意：** 应收到消息“无权执行此操作”**。 你未从虚拟网络进行连接。 此操作可能需要几分钟才能生效。 你可能仍然能够查看文件共享，但不能查看存储帐户中的文件或 Blob。 
